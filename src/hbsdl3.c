...
HB_FUNC( SDL_RENDERDEBUGTEXTFORMAT )
{
...
HB_FUNC( SDL_UTF8STRLEN )
{

}

HB_FUNC( SDL_UTF8STRNLEN )
{
...
HB_FUNC( SDL_WAITANDACQUIREGPUSWAPCHAINTEXTURE )
{
...
HB_FUNC( SDL_WAITFORGPUSWAPCHAIN )
{
